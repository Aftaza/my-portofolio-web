...
export default function Home() {
    return (
        <main className="flex min-h-screen flex-col items-center justify-between p-24">
            <Image src="/circle.svg" alt="the circle" width={180} height={180} className="fixed -top-8 -left-8 animate-wiggle hover:h-[220px] hover:w-[220px] transition-all ease-in-out duration-700" />
            <Image src="/Blops.svg" alt="the Blops" width={300} height={300} className="fixed -bottom-10 -left-4" />
            <Image src="/Plus.svg" alt="the plus or cross" width={150} height={150} className="fixed -top-6 -right-6 animate-wiggle" />
            <Image src="/Polygon.svg" alt="the polygon" width={150} height={150} className="fixed -bottom-7 right-0 hover:rotate-180 hover:w-[200px] hover:h-[200px] transition-all ease-in-out duration-700" />
            <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex flex-col gap-5">
                ...
                <Link href="/home"  className="mt-10 px-5 py-1 rounded-lg font-bold text-lg hover:px-10 bg-gradient-to-r from-indigo-700 from-0% via-purple-600 via-50% to-red-800 to-100% transition-all ease-in-out duration-1000">
                    Let`s Goo
                </Link>
            </div>
        </main>
